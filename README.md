...
.opencode/tools/web_search.sh "dummy" --url https://example.com   # direct page fetch
```
...
| `--url` | direct fetch of specific URL(s), skips search | Known-page retrieval, up to 50k chars per page |
